...
import profileImage from "../../assets/shivani_photo.jpeg"
const About = () => {
  return (
    <section id="about"
    ...
    >
      <div className="flex flex-col-reverse md:flex-row justify-between items-center">
        ...
        {/* Greeting */}
          ...
          {/* Resume Button */}
          <a href="https://drive.google.com/file/d/1EK2YSb5iAZfJOn2ERkGjcZuQhEkTWMR3/view?usp=sharing" target='_blank' rel='noopner noreferrer' className='inline-block text-white py-3 px-8 rounded-full mt-5 text-lg font-bold transition duration-300 transform hover:scale-105' style={{
        ...
        >   
             <img src={profileImage} alt="Shivani Gire" className='w-full h-full rounded-full object-cover drop-shadow-[0_10px_20px_rgba(130,69,236,0.5)]'/>
        </Tilt>
